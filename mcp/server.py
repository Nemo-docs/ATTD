...
from tools.page_tools import create_page, get_all_page_descriptions, get_page_by_id, get_all_snippets
...
mcp = FastMCP(   name="ATTD MCP server" ,
    instructions="""
        ...
        Call get_all_page_descriptions() to retrieve all page descriptions.
        Call get_page_by_id() to retrieve a specific page.
        Call get_all_snippets() to retrieve all snippets.
    """,)
...
mcp.tool(get_all_page_descriptions, name="get_all_page_descriptions",
    description="Retrieve all page descriptions for the authenticated user.",
    tags={"page", "list"},
)
...
mcp.tool(get_all_snippets, name="get_all_snippets",
    description="Retrieve all snippets for the authenticated user.",
    tags={"snippet", "list"},
)
